...
// SSID & Password
const char* ssid = "Hsiang";
const char* password = "0929200289";
   ...
   <html>\
    <head>\
      <style>\
        ...
        a { display:flex; justify-content:center; align-items:center; background: #070821; color:#fcfceb; width: 200px; height: 80px; margin: 20px; font-size: 30pt; text-decoration: none; border-radius:10px;}\
      </style>\
    </head>\
    <body>\
  ...
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a {display:flex; justify-content:center; align-items:center;  background:#fcfceb;c: #070821; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none; border-radius:10px;}\
      </style>\
    </head>\
    <body>\
      <h1>LED OPEN</h1>\
